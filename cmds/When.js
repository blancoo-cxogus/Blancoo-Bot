...
module.exports.run = (bot, message, args) => {
    if (!args[0]) return message.reply("<:xmark:651075973378211847> Вопрос не найден");
    ...
    if(!question.includes('?')) return message.reply("<:xmark:651075973378211847> Это не вопрос, поставь вопросительный знак")
